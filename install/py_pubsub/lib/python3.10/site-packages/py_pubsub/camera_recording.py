...
class DataRecorder(Node):
    def __init__(self):
        ...
        self.image = Image()
        self.image_count = 0
        self.image_save_path = "/home/riser14/ros_ws/MPPI_Images_Sparse"  # Replace with your image save path
        self.odom_csv_path = "/home/riser14/ros_ws/odom_data_mppisparse_test.csv" # Replace with your CSV file path
        ...
        self.timer = self.create_timer(0.5, self.save_odom_data_to_csv)
    ...
    def save_image(self):
        ...
        image_filename = os.path.join(self.image_save_path, f'test_image_{self.image_count}.png')
